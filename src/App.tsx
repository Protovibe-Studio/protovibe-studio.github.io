            ...
            {/* pv-editable-zone-start:z00096 */}
              ...
              <div data-pv-block="oc6h0r" className="animate-[hero-rise_700ms_ease-out_both] [animation-delay:160ms] flex gap-[12px] mt-[36px] flex-wrap justify-center items-stretch min-w-64 flex-row max-md:flex-col max-md:flex-nowrap max-md:w-full max-md:max-w-[320px] max-md:mx-auto">
                {/* pv-editable-zone-start:z00108 */}
                  ...
                  <a className="flex flex-col items-stretch" data-pv-block="s7lvih" href="https://github.com/Protovibe-Studio/protovibe-studio" target="_blank" rel="noreferrer">
          ...
          <div data-pv-block="t4dgb7" className="flex flex-col gap-2 items-center pt-5">
            ...
            <div data-pv-block="b00307" className="animate-[hero-rise_700ms_ease-out_both] [animation-delay:160ms] flex gap-[12px] mt-[36px] flex-wrap justify-center flex-col items-stretch min-w-64 z-2">
              {/* pv-editable-zone-start:z00108 */}
                ...
                <a className="flex items-stretch flex-col" data-pv-block="twnfpe" href="https://github.com/Protovibe-Studio/protovibe-studio" target="_blank" rel="noreferrer">
                  <Button leftIcon="mdi:github" label="Star on GitHub" variant="solid" color="neutral" size="lg" />
                </a>
                {/* pv-block-end:twnfpe */}
              {/* pv-editable-zone-end:z00108 */}
